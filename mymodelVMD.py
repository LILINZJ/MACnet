...
from component import TPA_TCN, BasicBlock1, ChannelAttention, conv3x3, eca_layer
...
class MyBlockWithVMD(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.BasicBlock = BasicBlock1(inplanes, planes, stride=1, downsample=None)
        self.BatchNorm1d = nn.BatchNorm1d(120, affine=False)
        self.ca = eca_layer(12)
        self.gru1 = nn.GRU(1, 2, 1, batch_first = True)
        self.tcn = TPA_TCN(120, 5, 32, [90,60,30,10])
        self.fc1 = nn.Linear(672, 50)
        # self.fc2 = nn.Linear(240, 20)
        self.fc3 = nn.Linear(370, 1)
        self.relu = nn.ReLU()
    ...
    def forward(self, x):
        ...
        outwater = outwater.reshape(batch_size, -1, 6)
        ...
        # out2 = x2.mean(2)
        out2 = self.conv(out2)
        out2 = out2.reshape(batch_size, 12, 7, 4)   
